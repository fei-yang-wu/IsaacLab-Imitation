...
UNITREE_G1_29DOF_USD_PATH = (
    str(UNITREE_G1_29DOF_USD_FILE) if UNITREE_G1_29DOF_USD_FILE.is_file() else None
)
...
UNITREE_G1_29DOF_MIMIC_ACTION_SCALE: dict[str, float] = {}
for actuator in UNITREE_G1_29DOF_MIMIC_CFG.actuators.values():
    ...
    for name in names:
        if name in effort_limit and name in stiffness and stiffness[name]:
            UNITREE_G1_29DOF_MIMIC_ACTION_SCALE[name] = (
                0.25 * effort_limit[name] / stiffness[name]
            )
