...
import subprocess
from imitation_experiments.paths import PAPER_DIR, REPO_ROOT


LAUNCHER = PAPER_DIR / "submit_bones_seed_multiseed_pipeline_skynet.sh"
# The guarded single-seed launcher is campaign implementation and sits here.
SINGLE_SEED_LAUNCHER = (
    REPO_ROOT
    / "experiments/campaigns/2026-07-23-bones-phase5-language-local10"
    / "interface_baselines/submit_bones_seed_multigoal_pipeline_skynet.sh"
)
