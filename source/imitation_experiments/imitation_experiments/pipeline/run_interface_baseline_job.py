...
# This file is handed to the cluster runner as a plain path (see
# CLUSTER_PYTHON_EXECUTABLE), so it stays stdlib-only and resolves the
# implementation as a sibling instead of importing the package.
