...
from imitation_experiments.capacity.run_capacity_entry import _runtime_env
...
def main() -> int:
    ...
    binding_module = "imitation_experiments.audit.validate_latent_skill_checkpoint_binding"
