...
# The guarded single-seed launcher is campaign implementation, not a
# release-facing entrypoint, so it lives outside experiments/paper/.
SINGLE_SEED_LAUNCHER="${REPO_ROOT}/experiments/campaigns/2026-07-23-bones-phase5-language-local10/interface_baselines/submit_bones_seed_multigoal_pipeline_skynet.sh"
