...
FRAMES_PER_BATCH=$((TRAIN_NUM_ENVS * FRAMES_PER_ENV_BATCH))
...
echo "[INFO] Pipeline: task='$TASK' seed='$SEED' train_num_envs='$TRAIN_NUM_ENVS' frames_per_batch='$FRAMES_PER_BATCH' max_iterations='$MAX_ITERATIONS' effective_frame_cap='$EFFECTIVE_FRAME_CAP'"
