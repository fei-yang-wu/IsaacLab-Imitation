...
# Repo-relative directory of this script, so sibling workflow scripts resolve
# correctly regardless of where the interface_baselines directory lives.
SCRIPT_REL = SCRIPT_DIR.relative_to(REPO_ROOT).as_posix()
# The three-seed paper launcher is a release-facing entrypoint and lives in
# experiments/paper/, not beside this campaign's implementation.
...
WORKFLOW_SOURCE_PATHS = (
    f"{SCRIPT_REL}/run_bones_seed_multigoal_language_comparison.py",
    f"{SCRIPT_REL}/submit_bones_seed_multigoal_pipeline_skynet.sh",
    f"{PAPER_REL}/submit_bones_seed_multiseed_pipeline_skynet.sh",
    "docker/cluster/submit_job_slurm_bones_pipeline.sh",
    f"{SCRIPT_REL}/validate_bones_seed_planner_submission.py",
    f"{SCRIPT_REL}/collect_interface_rollout_samples.py",
    f"{SCRIPT_REL}/balanced_motion_rows.py",
    f"{SCRIPT_REL}/closed_loop_metrics.py",
    f"{SCRIPT_REL}/low_level_tracker.py",
    f"{SCRIPT_REL}/planner_publish_schedule.py",
    f"{SCRIPT_REL}/paper_protocol_metadata.py",
    f"{SCRIPT_REL}/planner_latency.py",
    "scripts/rlopt/eval_skill_commander_closed_loop.py",
    f"{SCRIPT_REL}/eval_interface_planner_closed_loop.py",
    f"{SCRIPT_REL}/train_chunked_transformer_planner.py",
    f"{SCRIPT_REL}/eval_interface_planner_offline.py",
    f"{SCRIPT_REL}/merge_planner_samples.py",
    f"{SCRIPT_REL}/planner_sample_schema.py",
    f"{SCRIPT_REL}/interface_planner_common.py",
    f"{SCRIPT_REL}/audit_bones_seed_multigoal_language_comparison.py",
    f"{SCRIPT_REL}/summarize_bones_seed_multigoal_language_comparison.py",
