...
run_cmd env \
    ...
    experiments/campaigns/2026-07-23-bones-phase5-language-local10/interface_baselines/run_shared_latent_interface_comparison.sh
...
run_cmd env \
    ...
    experiments/campaigns/2026-07-23-bones-phase5-language-local10/interface_baselines/run_dance102_strong_interface_comparison.sh
