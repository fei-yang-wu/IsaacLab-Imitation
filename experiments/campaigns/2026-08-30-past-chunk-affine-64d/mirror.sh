#!/usr/bin/env bash
# Pull past-chunk-affine-64d encoders and tracker checkpoints off ICE into the
...
REMOTE_ROOT="${REMOTE_ROOT:-/home/hice1/fwu91/scratch/Research/IsaacLab/data/past_chunk_affine_64d}"
