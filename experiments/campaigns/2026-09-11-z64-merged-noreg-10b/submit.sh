#!/usr/bin/env bash
# Plan one arm of the z64-merged-noreg-10b campaign through the cluster control plane.
...
# command. The W&B project is g1-bs-ablation and the group is latent64-probe-10b.
set -euo pipefail
