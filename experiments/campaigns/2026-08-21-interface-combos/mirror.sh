...
REMOTE_ROOT="${REMOTE_ROOT:-/home/hice1/fwu91/scratch/Research/IsaacLab/data/interface_combos}"
...
import yaml
c = yaml.safe_load(open('experiments/campaigns/2026-08-21-interface-combos/campaign.yaml'))
