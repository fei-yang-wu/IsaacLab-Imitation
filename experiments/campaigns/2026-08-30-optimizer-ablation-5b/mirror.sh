#!/usr/bin/env bash
# Pull optimizer-ablation-5b checkpoints off ICE into the layout `eval.sh` reads.
#
...
#
#   ./mirror.sh                 # every arm
#   ARMS="ctrl mb_half_e3" ./mirror.sh
...
REMOTE_ROOT="${REMOTE_ROOT:-/home/hice1/fwu91/scratch/Research/IsaacLab/data/optimizer_ablation_5b}"
