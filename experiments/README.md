...
| --- | --- | --- |
| Primary (submitted) | [`2026-09-04-direct-affine-phi`](campaigns/2026-09-04-direct-affine-phi/README.md) | Encoder pretraining is running on ICE; two tracker segments are pending their dependencies. One 10B arm, 20,480 environments, 64-D phi plus two phase values. z64, weight decay, linear critic schedule, LayerNorm past-5 encoder, and LSTM; no explicit actor history. W&B project `g1-bs-pareto`, group `direct-affine-phi`. Local tests, simulator smoke, and live preflight passed. |
