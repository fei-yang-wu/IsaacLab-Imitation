...
def _resolve_manifest_cli_overrides(env_cfg: Any) -> None:
...
def _tracking_metrics(
    ...
    *,
    ...
    root_quat_w = getattr(robot_data.root_quat_w, "torch", robot_data.root_quat_w)
...
def _run(
    ...
    torch.random.default_generator.manual_seed(agent_cfg.seed)
